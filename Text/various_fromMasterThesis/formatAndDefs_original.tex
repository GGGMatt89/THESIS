...
\usepackage{pdfpages}
\usepackage[left=3.15cm,right=2.55cm,top=1.8cm,bottom=1.09cm,includefoot,includehead,headheight=13.6pt]{geometry}
\usepackage{setspace}
\setstretch{1.1}
...
\usepackage[b5paper,hyperindex=true,plainpages=false]{hyperref}%OK
